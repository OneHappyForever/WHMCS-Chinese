...
$_LANG['affiliatesrealtime'] = "這些統計數據是實時和即時更新的";
$_LANG['affiliatesreferallink'] = "屬於您的唯一推廣鏈接";
$_LANG['affiliatesreferals'] = "您的引薦";
...
$_LANG['forwardingtogateway'] = "正在重定向到您選擇付款網關，請稍等...";
...
$_LANG['or'] = "或";
$_LANG['orderadditionalrequiredinfo'] = "其他必要信息";
...
$_LANG['orderPromoCodePlaceholder'] = "請輸入您的優惠代碼";
...
$_LANG['supportticketserrornosubject'] = "您未填寫訊息主题";
$_LANG['supportticketsfilenotallowed'] = "您嘗試上傳的檔案不符合允許的格式。";
$_LANG['supportticketsheader'] = "您可以在此提交您遇到的問題，客服人員在收到後會盡快回答。 <br/><br/><b>使用說明：</b><br/>1. 請先閱讀『幫助中心』的文檔，並合理使用搜索引擎，您的問題也許很普遍，已經在網上被回答了很多次，直接找到答案會更加節省您的時間。 <br/>2. 請選擇正確的部門提交您的問題，每個部門所處理的具體事項在部門名稱後有具體說明。 <br/>3. 各部門的工作時間為每天 9:00-23:00。 <br/><br/><b>服務承諾：</b><br/>您在工作時間內提交的問題，將在 6 小時內答复，24 小時內解決。非工作時間提交的問題，由值班人員盡快答复。 <br/><br/><b>請在此選擇受理您的提問的部門：</b><br/>";
...
$_LANG['supportticketssystemdescription'] = "支持服務系統能夠讓我們盡快回复您的問題和查詢。當我們回复您的服務單時，您將收到電子郵件通知。";
...
$_LANG['supportticketsuploadtoolarge'] = "上傳的文件太大了,請嘗試上傳較小的文件。";
...
$_LANG['promoappliedbutnodiscount'] = "您輸入的促銷代碼已應用於您的購物車，但尚未有任何商品符合該折扣 - 請查看促銷條款";
...
$_LANG['affiliatesignuptitle'] = "引薦客戶給我們來索取報酬";
$_LANG['affiliatesignupintro'] = "激活您的推廣賬戶，並開始獲取收益...";
$_LANG['affiliatesignupinfo1'] = "我們將為通過您的專屬註冊鏈接進行的每次註冊支付佣金。";
$_LANG['affiliatesignupinfo2'] = "我們 Cookies 跟踪您向我們推薦的訪問者，所以就算您引薦的用戶沒有立即購買，您也會在其購買後收到佣金。首次訪問後，Cookie 的有效期可持續長達 90 天。";
$_LANG['affiliatesignupinfo3'] = "如果您想了解更多信息，請與我們聯繫。";
...
$_LANG['nosupportdepartments'] = "找不到支持部門。請稍後再試。";
...
$_LANG['due'] = "Due";
$_LANG['affiliatessignups'] = "註冊數";
$_LANG['affiliatesconversionrate'] = "轉化率";
$_LANG['affiliatesclicks'] = "點擊數";
$_LANG['contacts'] = "聯絡人";
...
$_LANG['clientAlerts']['invoicesUnpaid'] = "您有 :numberOfInvoices 張未付款的發票. 儘早付錢，讓我們安心。";
$_LANG['clientAlerts']['invoicesOverdue'] = "您有 :numberOfInvoices 張逾期發票 總額為 :balanceDue. 現在支付它們以避免服務中斷。";
$_LANG['clientAlerts']['creditBalance'] = "您當前餘額為 :creditBalance.";
...
$_LANG['clientHomePanels']['affiliateSummary'] = "您已經通過推廣賺到了:commissionBalance, 您需要再賺:amountUntilWithdrawalLevel 才能够提现。";
...
$_LANG['affiliateWithdrawalSummary'] = "一旦您的推薦佣金達到最低要求的:amountForWithdrawal，您就可以申請提款。";
...
$_LANG['orderForm']['createAccount'] = "創建新賬戶";
$_LANG['orderForm']['enterPersonalDetails'] = "請輸入您的個人詳細信息和結算信息以便結帳。";
$_LANG['orderForm']['correctErrors'] = "請在繼續之前更正以下錯誤";
$_LANG['orderForm']['existingCustomerLogin'] = "現有客戶登錄";
$_LANG['orderForm']['emailAddress'] = "電子郵箱";
$_LANG['orderForm']['personalInformation'] = "個人信息";
$_LANG['orderForm']['firstName'] = "暱稱";
$_LANG['orderForm']['lastName'] = "姓";
$_LANG['orderForm']['phoneNumber'] = "手機號碼";
...
$_LANG['orderForm']['additionalNotes'] = "補充說明";
...
$_LANG['orderForm']['addToCart'] = "添加到購物車";
$_LANG['orderForm']['addedToCartRemove'] = "從購物車中移除";
$_LANG['orderForm']['configureDesiredOptions'] = "配置所需的選項並繼續結帳。";
$_LANG['orderForm']['haveQuestionsContact'] = "有問題嗎？聯繫我們的銷售團隊尋求幫助。";
...
$_LANG['orderForm']['promotionAccepted'] = "促銷代碼已被接受！您的訂單總額已更新。";
...
$_LANG['orderForm']['applyPromoCode'] = "促銷代碼";
$_LANG['orderForm']['estimateTaxes'] = "Estimate Taxes";
$_LANG['orderForm']['removePromotionCode'] = "刪除促銷代碼";
$_LANG['orderForm']['updateTotals'] = "Update Totals";
$_LANG['orderForm']['continueShopping'] = "繼續購買";
...
$_LANG['orderForm']['errorNoProducts'] = "產品組不包含任何可見產品！";
...
$_LANG['verifyEmailAddress'] = "請檢查您的電子郵件，然後點擊該鏈接驗證您的電子郵件地址。";
$_LANG['resendEmail'] = "重新發送驗證郵件";
...
$_LANG['cart']['availableCreditBalance'] = "您當前可用餘額為 :amount.";
...
$_LANG['cart']['applyCreditAmountNoFurtherPayment'] = "從我的餘額中支付此訂單 <span>:amount</span>，不再支付任何款項。";
$_LANG['cart']['applyCreditSkip'] = "請勿將我的餘額用於此訂單，我會使用下面選擇的付款方式付款。";
